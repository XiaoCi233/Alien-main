...
public class BaritoneModule extends Module {
   ...
   public static void forward() {
      ...
      int x = mc.player.getBlockX() + direction.getVector().getX() * 30000000;
      int z = mc.player.getBlockZ() + direction.getVector().getZ() * 30000000;
      cancelEverything();
   ...
   public void onUpdate(UpdateEvent event) {
      BaritoneAPI.getSettings().blockReachDistance.value = this.rangeConfig.getValueFloat();
